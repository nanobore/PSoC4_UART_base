// ======================================================================
// UartComm_base.v generated from TopDesign.cysch
// 12/19/2017 at 16:26
...
module ADC_SAR_SEQ_P4_v2_50_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("18443c39-33e5-4283-a48b-a6e68550d2ed/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("18443c39-33e5-4283-a48b-a6e68550d2ed/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    CyControlReg_v1_80 LED_ControlReg (
        .control_1(Net_106),
        .control_2(Net_107),
        .control_3(Net_108),
        .control_0(Net_104),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam LED_ControlReg.Bit0Mode = 0;
    defparam LED_ControlReg.Bit1Mode = 0;
    defparam LED_ControlReg.Bit2Mode = 0;
    defparam LED_ControlReg.Bit3Mode = 0;
    defparam LED_ControlReg.Bit4Mode = 0;
    defparam LED_ControlReg.Bit5Mode = 0;
    defparam LED_ControlReg.Bit6Mode = 0;
    defparam LED_ControlReg.Bit7Mode = 0;
    defparam LED_ControlReg.BitValue = 0;
    defparam LED_ControlReg.BusDisplay = 0;
    defparam LED_ControlReg.ExtrReset = 0;
    defparam LED_ControlReg.NumOutputs = 1;
	...
	wire [0:0] tmpOE__ADC_plus_net;
	wire [0:0] tmpFB_0__ADC_plus_net;
	wire [0:0] tmpIO_0__ADC_plus_net;
	wire [0:0] tmpINTERRUPT_0__ADC_plus_net;
	electrical [0:0] tmpSIOVREF__ADC_plus_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		ADC_plus
		 (.oe(tmpOE__ADC_plus_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_plus_net[0:0]}),
		  .analog({Net_140}),
		  .io({tmpIO_0__ADC_plus_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_plus_net),
		  .interrupt({tmpINTERRUPT_0__ADC_plus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_plus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ADC_minus_net;
	wire [0:0] tmpFB_0__ADC_minus_net;
	wire [0:0] tmpIO_0__ADC_minus_net;
	wire [0:0] tmpINTERRUPT_0__ADC_minus_net;
	electrical [0:0] tmpSIOVREF__ADC_minus_net;

	cy_psoc3_pins_v1_10
		#(.id("4e87b5ac-6920-4715-b896-c1a0087ba004"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ADC_minus
		 (.oe(tmpOE__ADC_minus_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_minus_net[0:0]}),
		  .analog({Net_139}),
		  .io({tmpIO_0__ADC_minus_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_minus_net),
		  .interrupt({tmpINTERRUPT_0__ADC_minus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_minus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_ADC_Test_net;
	wire [0:0] tmpFB_0__Pin_ADC_Test_net;
	wire [0:0] tmpIO_0__Pin_ADC_Test_net;
	wire [0:0] tmpINTERRUPT_0__Pin_ADC_Test_net;
	electrical [0:0] tmpSIOVREF__Pin_ADC_Test_net;

	cy_psoc3_pins_v1_10
		#(.id("c8a006fb-ac52-49b6-ae0b-0527457ee2c4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_ADC_Test
		 (.oe(tmpOE__Pin_ADC_Test_net),
		  .y({Net_149}),
		  .fb({tmpFB_0__Pin_ADC_Test_net[0:0]}),
		  .io({tmpIO_0__Pin_ADC_Test_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_ADC_Test_net),
		  .interrupt({tmpINTERRUPT_0__Pin_ADC_Test_net[0:0]}),
		  .annotation({Net_157}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_ADC_Test_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 TestControlReg (
        .control_1(Net_146),
        .control_2(Net_147),
        .control_3(Net_148),
        .control_0(Net_149),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam TestControlReg.Bit0Mode = 0;
    defparam TestControlReg.Bit1Mode = 0;
    defparam TestControlReg.Bit2Mode = 0;
    defparam TestControlReg.Bit3Mode = 0;
    defparam TestControlReg.Bit4Mode = 0;
    defparam TestControlReg.Bit5Mode = 0;
    defparam TestControlReg.Bit6Mode = 0;
    defparam TestControlReg.Bit7Mode = 0;
    defparam TestControlReg.BitValue = 0;
    defparam TestControlReg.BusDisplay = 0;
    defparam TestControlReg.ExtrReset = 0;
    defparam TestControlReg.NumOutputs = 1;
